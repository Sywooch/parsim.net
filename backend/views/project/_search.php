...
<div class="orgunit-search">
    ...
    <?= 
        $form->field($model, 'status',['template'=>'{label}{input}{error}'])->checkboxList(Lookup::items('PROJECT_STATUS'),['item'=>function ($index, $label, $name, $checked, $value){
          return '
