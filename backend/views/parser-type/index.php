...
$this->title = Yii::t('app', 'Parser types');
$this->params['breadcrumbs'][] = $this->title;
$this->params['bodyClass']='has-detached-right';

use backend\assets\parserType\IndexAsset;
IndexAsset::register($this);

?>
<div class="parser-type-index">
  <p>
    <?= Html::a(Yii::t('app', 'Create type'), $model->createUrl, ['class' => 'btn btn-success']) ?>
  </p>
