            ...
            <div class="clearfix">
                  ...
                  <div class="top-left">
                    <ul class="link-nav clearfix">
                        <li ><span class="theme_color"><a href="<?= Transaction::getCreateUrl(); ?>" class="text-warning"><span class="icon fa fa-warning"></span>Внимание! На Вашем счете недостаточно средств.</a></span></li>
                      </ul>
                  </div>
