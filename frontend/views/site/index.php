...
$this->params['keywords']='Парсер, парсер сайтов, парсинг, парсинг сайтов, бесплатный парсер, Parsim.NET, создание парсера, парсер на заказ, парсер скачать, парсеры контента, облачный парсер, парсер новостей, парсер вк, парсер онлайн, парсер картинок, парсер товаров, парсер магазина, дешевый парсер, удобный парсер'; 
        ...
        <div class="rev_slider fullwidthabanner" id="rev_slider_486_1" data-version="5.4.1">
            <ul>
                ...
                style="z-index: 7; white-space: nowrap;text-transform:left;">
                  <h2><span class="theme_color">On-line</span> <br> парсер товаров</h2>
                </div>
                ...
                style="z-index: 7; white-space: nowrap;text-transform:left;">
                    <div class="text">
                        Сообщите нам <b>URL</b> интересующих Вас товаров из различных источников, а мы оперативно предоставим Вам подробную информацию о них в единообразном виде. Результаты можем отправить на Ваш <b>E-mail</b> в виде таблицы и/или на Ваш <b>API</b> интерфейс в формате <b>JSON</b>.  
                    </div>
                </div>
        ...
        <div class="row clearfix">
            ...
            <div class="content-column col-md-7 col-sm-12 col-xs-12">
                <div class="inner-content">
                    ...
                    <div class="dark-text">
                        <p>
                            Мы создали конвейер по производству и централизованному мониторингу наших парсеров. 
                        </p>
                        <p>
                            Это означает, что Вам больше не нужно искть специалистов, которые напишут под Вас парсер...    
                        </p>
