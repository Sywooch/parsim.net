  ...
  <div class="row clearfix">
      <div class="column col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="column col-md-6 col-sm-12 col-xs-12">
            <div class="text">
                Убедитесь сами!<br/>
                Мы постарались сделать наш сервис максимально простым,
    ...
    <div class="services-block col-md-4 col-sm-6 col-xs-12">
      <div class="inner-box wow fadeIn" data-wow-duration="1500ms" data-wow-delay="0ms">
          <div class="icon-box">
            ...
            <h3>Удобно</h3>
            <p class="text">
              Любые настройки, например, добавлить/удалить URL или настроить частоту сканирования, Вы можете в WEB интерфейсе или через API Parsim.NET
            </p>
        </div>
    </div>
