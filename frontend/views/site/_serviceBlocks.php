    ...
    <div class="services-block col-md-4 col-sm-6 col-xs-12">
      <div class="inner-box wow fadeIn" data-wow-duration="1500ms" data-wow-delay="300ms">
          <div class="icon-box">
            ...
            <h3>Просто</h3>
            <p class="text">
              Добавьте URL интересующих товаров и получайте результаты на Ваш E-mail или API-интерфейс с заданной периодичностью.
            </p>
        </div>
    </div>
    ...
    <div class="services-block col-md-4 col-sm-6 col-xs-12">
      <div class="inner-box wow fadeIn" data-wow-duration="1500ms" data-wow-delay="0ms">
          <div class="icon-box">
            ...
            <h3>Удобно</h3>
            <p class="text">
              Добавлять, изменять и удалять URL, контролировать остаток средств, Вы можете с помощью WEB интерфейса и при помощи API.
            </p>
        </div>
    </div>
