  ...
  <div class="row clearfix">
      <div class="column col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="column col-md-6 col-sm-12 col-xs-12">
            <div class="text">
                Убедитесь сами!<br/>
                Мы сделали наш сервис максимально простым,
                понятным и удобным в повседневном использовании
            </div>
        </div>
    </div>
</div>
...
<div class="row clearfix" >
    ...
    <div class="services-block col-md-4 col-sm-6 col-xs-12">
      <div class="inner-box wow fadeIn" data-wow-duration="1500ms" data-wow-delay="300ms">
          <div class="icon-box">
            ...
            <h3>Просто</h3>
            <p class="text">
              Добавьте через API или WEB итерфейс URL интересующих товаров и получайте результаты на Ваш E-mail или API-интерфейс с заданной переиодичностью.
            </p>
        </div>
    </div>
    ...
    <div class="services-block col-md-4 col-sm-6 col-xs-12">
      <div class="inner-box wow fadeIn" data-wow-duration="1500ms" data-wow-delay="0ms">
          <div class="icon-box">
            ...
            <h3>Удобно</h3>
            <p class="text">
              Любые настройки, например, добавлить или удалить URL, настроить частоту сканирования, Вы можете в WEB интерфейсе или через API Parsim.NET
            </p>
        </div>
    </div>
    ...
    <div class="services-block col-md-4 col-sm-6 col-xs-12" id="services-block">
        <div class="inner-box wow fadeIn" data-wow-duration="1500ms" data-wow-delay="600ms">
            ...
            <h3>Надежно</h3>
            <p class="text">
              Наши парсеры работают как часы! Но если по какой-то причине мы не сможем обработать Ваш запрос, мы вернем Вам деньги.
            </p>
        </div>
    </div>
