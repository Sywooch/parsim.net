      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" >
              <tr>
                <td height="300"><img src="hhttp://parsim.net/images/email/blank.gif" alt="" width="1" height="1" /></td>
              </tr>
            </table>
          </td>
          ...
          <table width="100%" cellspacing="0" cellpadding="0" border="0">
            ...
            <tr>
              <td style="text-align: center;color:#767781; font-family: 'Lato', sans-serif;font-size:20px; font-weight: 300; word-spacing: 1px;">
                <p>Обработка Ваших URL в <span style="font-weight: 700;color:#000">Parsim <span style="color:#ff5926;">NET</span></span> временно приостановлена</p>
              </td>
            </tr>
            ...
            <tr>
              <td style="text-align: center;color:#000; font-family: 'Lato', sans-serif;font-size:18px; font-weight: 500; word-spacing: 1px;">
                <p style="padding: 0px 20px;">
                  Для восстановления работы необходимо пополнить счет.
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td style="text-align: center;color:#767781; font-family: 'Lato', sans-serif;font-size:20px; font-weight: 400; word-spacing: 1px;">
                <a href="<?= $payUrl; ?>" style="text-decoration: none; padding:15px 40px; width: 40%; height: 60px; background: none; color: #1f2936; border: 2px solid #2b3d5e;">
                   Пополнить счет
                </a>
              </td>
