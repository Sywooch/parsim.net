      ...
      <tr>
        ...
        <td>
          <table width="100%" cellspacing="0" cellpadding="0" border="0">
            ...
            <tr>
              <td style="text-align:center;color:#444; font-family: 'Lato', sans-serif;font-size:16px; font-weight: 500; word-spacing: 1px;">
                <p style="padding: 0px 20px;">
                  Учетная запись <?= $model->email; ?> успешно активирована.</p>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="text-align: left;color:#000; font-family: 'Lato', sans-serif;font-size:24px; font-weight: 500; word-spacing: 1px;">
                <p style="padding: 0px 20px;">
                  Важная информация:
                </p>
              </td>
            ...
            <tr>
              <td style="text-align: left;color:#000; font-family: 'Lato', sans-serif;font-size:18px; font-weight: 500; word-spacing: 1px;">
                <p style="padding: 0px 20px;">
                  Личный кабинет: http://admin.parsim.net
                </p>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="text-align: left;color:#000; font-family: 'Lato', sans-serif;font-size:18px; font-weight: 500; word-spacing: 1px;">
                <p style="padding: 0px 20px;">
                  Ключ доступа к сервису по API:: <?= $model->auth_key; ?>
                </p>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="text-align: left;color:#000; font-family: 'Lato', sans-serif;font-size:18px; font-weight: 500; word-spacing: 1px;">
                <p style="padding: 0px 20px;">
                  <a href="<?= $model->passwordRecoveryUrl;; ?>/api">Смена пароля</a>
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td style="text-align: left;color:#000; font-family: 'Lato', sans-serif;font-size:18px; font-weight: 500; word-spacing: 1px;">
                <p style="padding: 0px 20px;">
                  <a href="<?= Yii::$app->params['frontendUrl']; ?>/api"> Справочник по работе с API</a>
                </p>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="text-align: left;color:#000; font-family: 'Lato', sans-serif;font-size:18px; font-weight: 500; word-spacing: 1px;">
                <p style="padding: 0px 20px;">
                  <a href="<?= Yii::$app->params['frontendUrl']; ?>/faq"> Часто задаваемые вопросы</a>
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td style="text-align: center;color:#767781; font-family: 'Lato', sans-serif;font-size:20px; font-weight: 400; word-spacing: 1px;">
                <a href="<?= Yii::$app->params['backendUrl']; ?>" style="text-decoration: none; padding:15px 40px; width: 40%; height: 60px; background: none; color: #1f2936; border: 2px solid #2b3d5e;">
