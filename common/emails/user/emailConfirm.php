  ...
  <td style="background-color: #ffffff;">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="<!-- background-color:#fff -->; ">
      <tr>
        ...
        <td width="34"><img src="<?= Yii::$app->params['srcUrl']; ?>/email/blank.gif" alt="" width="1" height="1" /></td>
        <td>
          <table width="100%" cellspacing="0" cellpadding="0" border="0">
            <tr>
              <td height="67"><img src="<?= Yii::$app->params['srcUrl']; ?>/email/blank.gif" alt="" width="1" height="1" /></td>
            </tr>
            ...
            <tr>
              <td height="10"><img src="<?= Yii::$app->params['srcUrl']; ?>/email/blank.gif" alt="" width="1" height="1" /></td>
            </tr>
            ...
            <tr>
              <td height="40"><img src="<?= Yii::$app->params['srcUrl']; ?>/email/blank.gif" alt="" width="1" height="1" /></td>
            </tr>
            <tr>
              <td style="text-align: left;color:#767781; font-family: 'Lato', sans-serif;font-size:20px; font-weight: 400; word-spacing: 1px;">
                <p style="padding: 0px 20px;">МЫ - те, кто испоьзует современные технологии чтобы облегчить жизнь</p>
              </td>
            </tr>

            <tr>
              <td height="20"><img src="<?= Yii::$app->params['srcUrl']; ?>/email/blank.gif" alt="" width="1" height="1" /></td>
            </tr>
            <tr>
              <td style="text-align: left;color:#767781; font-family: 'Lato', sans-serif;font-size:20px; font-weight: 400; word-spacing: 1px;">
                <p style="padding: 0px 20px;">МЫ - те, кто делает сложные вещи простыми и понятными </p>
              </td>
            </tr>
            ...
            <tr>
              <td style="text-align: left;color:#767781; font-family: 'Lato', sans-serif;font-size:20px; font-weight: 400; word-spacing: 1px;">
                <p style="padding: 0px 20px;">МЫ - убеждены, что всю рутинную должны делать роботы, а человек заниматься ителектуальной деятельностью или отдыхать ;) </p>
              </td>
            </tr>

            <tr>
              <td height="60"><img src="<?= Yii::$app->params['srcUrl']; ?>/email/blank.gif" alt="" width="1" height="1" /></td>
            </tr>
            <tr>
              <td style="text-align: center;color:#444; font-family: 'Lato', sans-serif;font-size:25px; font-weight: 400; word-spacing: 1px;">
                <p style="padding: 0px 20px;">
                  Мы получили запрос регистрации нового пользователя
                </p>
            ...
            <tr>
              <td style="text-align: center;color:#444; font-family: 'Lato', sans-serif;font-size:25px; font-weight: 500; word-spacing: 1px;">
                <p style="padding: 0px 20px;">
            ...
            <tr>
              <td style="text-align: left;color:#767781; font-family: 'Lato', sans-serif;font-size:20px; font-weight: 400; word-spacing: 1px;">
                <p style="padding: 0px 20px;">
                  Спешим, сообщить, что уже все готово!
              </td>
            </tr>
            <tr>
              <td height="5"><img src="<?= Yii::$app->params['srcUrl']; ?>/email/blank.gif" alt="" width="1" height="1" /></td>
            </tr>
            <tr>
              <td style="text-align: left;color:#767781; font-family: 'Lato', sans-serif;font-size:20px; font-weight: 400; word-spacing: 1px;">
                <p style="padding: 0px 20px;">
            ...
            <tr>
              <td style="text-align: left;color:#767781; font-family: 'Lato', sans-serif;font-size:20px; font-weight: 400; word-spacing: 1px;">
                <p style="padding: 0px 20px;">
                  Все что осталось сделать, это активировать Вашу учетную запись.
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td height="80"><img src="<?= Yii::$app->params['srcUrl']; ?>/email/blank.gif" alt="" width="1" height="1" /></td>
            </tr>
            <tr>
            ...
            <tr>
              <td height="62"><img src="<?= Yii::$app->params['srcUrl']; ?>/email/blank.gif" alt="" width="1" height="1" /></td>
            </tr>
          </table>
        </td>
