...
class m170605_131114_create_tarif_option_table extends Migration
{
    public function up()
    {
        ...
        $this->batchInsert('{{%tarif_option}}', ['tarif_id','title','order_num'], [
            ...
            //pay-per-action
            [3,'Мах. частота обновлений - раз в час',1],
            [3,'Неограниченное кол-во ссылок',2],
            [3,'Тех. поддержка с 9:00 до 17:00, Пн.-Пт.',3],
            [3,'Добавление новых сайтов - бесплатно',4],
            [3,'Доступ в личный кабинет',5],
            [3,'Доступ по API',6],
